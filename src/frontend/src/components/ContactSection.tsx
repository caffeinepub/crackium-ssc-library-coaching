                ...
                {[
                  ...
                  <div key={label} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-sans text-sm text-[var(--cream)]">
                        {value}
                      </div>
                    </div>
                  </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="brand" className="bg-[var(--charcoal)]">
                      Brand Identity
                    </option>
                    <option value="web" className="bg-[var(--charcoal)]">
                      Web Design & Dev
                    </option>
                    <option value="motion" className="bg-[var(--charcoal)]">
                      Motion & Animation
                    </option>
                    <option value="strategy" className="bg-[var(--charcoal)]">
                      Digital Strategy
                    </option>
                    <option value="other" className="bg-[var(--charcoal)]">
                      Other
                    </option>
                  </select>
                </div>
