...
function MarqueeItem() {
  return (
    <>
      ...
      <span className="w-1.5 h-1.5 rounded-full bg-[var(--gold)] opacity-40 flex-shrink-0 mx-6" />
      <span className="font-display text-lg font-light italic text-[oklch(97%_0.012_95_/_0.15)]">
        Web Design
      </span>
      <span className="w-1.5 h-1.5 rounded-full bg-[var(--gold)] opacity-40 flex-shrink-0 mx-6" />
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-8 bg-[var(--forest)] flex items-center justify-center">
                <span className="text-[var(--cream)] font-display font-bold text-sm">
                  V
                </span>
              </div>
            ...
            <p className="font-sans text-sm text-[oklch(97%_0.012_95_/_0.4)] leading-relaxed max-w-xs mb-8">
              A creative studio crafting bold digital experiences, brand
              identities, and visual stories that move people.
            </p>
            <a
              href="#contact"
